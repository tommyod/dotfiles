...
plugins=(git colored-man-pages copydir emoji-clock zsh-autosuggestions zsh-syntax-highlighting)
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/tommy/anaconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/home/tommy/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/tommy/anaconda3/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/home/tommy/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda init <<<
...
# Call `ls` when a directory is changed
chpwd() ls
